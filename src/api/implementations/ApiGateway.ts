...
import { MonthlyLimitService } from "./MonthlyLimitService";
...
const REST_API_BASE_URL = process.env.EXPO_PUBLIC_REST_API_BASE_URL;
...
export class ApiGateway implements IApiGateWay {
  ...
  constructor() {
    ...
    this.transactionService = new TransactionService(this.config, this.ajaxUtils);
